...
from src.config_data import TICKER_LIST_lists, TRAIN_START_DATE, TRAIN_END_DATE, TEST_START_DATE, TEST_END_DATE, TIME_INTERVAL, ALPACA_API_KEY, ALPACA_API_SECRET, ALPACA_API_BASE_URL, TIME_INTERVAL
...
class AlpacaProcessor:
    ...
    def download_data(
        ...
        if pd.Timedelta(time_interval).days < day_delta:
