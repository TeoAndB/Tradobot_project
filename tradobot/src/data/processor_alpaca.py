...
from src.config import TICKER_LIST_lists, TRAIN_START_DATE, TRAIN_END_DATE, TEST_START_DATE, TEST_END_DATE, TIME_INTERVAL, ALPACA_API_KEY, ALPACA_API_SECRET, ALPACA_API_BASE_URL, TIME_INTERVAL
